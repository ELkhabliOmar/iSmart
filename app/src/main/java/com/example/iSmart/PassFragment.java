...
import com.example.iSmart.databinding.ActivityMainBinding;
...
public class PassFragment extends Fragment {
    ...
    private void updateCamera(Point point, Double bearing) {
        ...
        CameraOptions cameraOptions = new CameraOptions.Builder().center(point).zoom(18.0).bearing(bearing).pitch(45.0)
                .padding(new EdgeInsets(500.0, 0.0, 0.0, 0.0)).build();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        speechApi = new MapboxSpeechApi(Objects.requireNonNull(getContext()), getString(R.string.mapbox_access_token), Locale.US.toLanguageTag());
...
//
    ...
    private void fetchRoute(Point point) {
        LocationEngine locationEngine = LocationEngineProvider.getBestLocationEngine(Objects.requireNonNull(getContext()));
    ...
    public void onDestroy() {
        super.onDestroy();
        // Assuming mapboxNavigationInstance is your MapboxNavigation instance
        if (mapboxNavigation != null) {
            mapboxNavigation.onDestroy();
            mapboxNavigation = null; // Set to null to release the reference
        }
    }
}